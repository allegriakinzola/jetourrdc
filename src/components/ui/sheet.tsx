...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-none opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:outline-none">
...
function SheetTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("font-display text-lg tracking-[0.16em]", className)}
      {...props}
    />
  );
}
